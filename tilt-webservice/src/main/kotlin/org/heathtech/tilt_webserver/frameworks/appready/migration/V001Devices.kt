package org.heathtech.tilt_webserver.frameworks.appready.migration
...
import org.heathtech.tilt_webserver.frameworks.exposed.tilt.TiltDeviceDao
...
class V001Devices : DatabaseMigration {
    ...
    override fun applyMigration(): Unit = transaction {
        TiltDeviceDao.new {
            name = "Tilt Red"
