package org.heathtech.tilt_webserver.frameworks.appready

import org.heathtech.tilt_webserver.domain.migration.DatabaseMigration
import org.heathtech.tilt_webserver.frameworks.exposed.migration.MigrationTable
...
class PrepopulateData(
    ...
    fun runDatabaseMigrations() = transaction {
        SchemaUtils.createMissingTablesAndColumns()

        val latestVersion = MigrationTable
        ...
        val maxAppliedVersion = migrations
